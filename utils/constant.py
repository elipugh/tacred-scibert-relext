...
LIFE_LABEL_TO_ID = {'no_relation': 0, 'is-at': 1, 'is-along': 2, 'possesses': 3, 'raw-material': 4, 'is-opposite': 5, 'does-not-enclose': 6, 'is-parallel-to': 7, 'has-part': 8, 'wavelength': 9, 'surface-area': 10, 'is-inside': 11, 'is-below': 12, 'encloses': 13, 'first-subevent': 14, 'agent': 15, 'donor': 16, 'shape': 17, 'object': 18, 'is-across': 19, 'is-above': 20, 'base': 21, 'atomic-weight': 22, 'result': 23, 'area': 24, 'has-ion': 25, 'subclass-of': 26, 'abuts': 27, 'is-on': 28, 'instrument': 29, 'is-between': 30, 'length': 31, 'mass': 32, 'size': 33, 'is-facing': 34, 'volume': 35, 'element': 36, 'has-on-it': 37, 'is-outside': 38, 'recipient': 39, 'subevent': 40, 'is-near': 41, 'experiencer': 42, 'next-event': 43, 'has-region': 44}
